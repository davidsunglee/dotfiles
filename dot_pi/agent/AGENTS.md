...
2. Project-local guidance (e.g., a repo's `AGENTS.md`, `CLAUDE.md`)
...
- **For any bug, write a failing regression test first**, then fix. The test should reproduce the real failure path, not a sanitized version of it.
